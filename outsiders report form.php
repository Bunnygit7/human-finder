...
<head>
    ...
    <title>Outsiders Child Report</title>
    <style>
        body {
...
<body style="margin:0%">
    ...
    <img class="outsiders_cap" src="photos for project/out-removebg-preview.png" alt="">

    <div class="frm" style="margin-top: 10%; position: absolute; width: 100%;">
        <form id="reportForm" action="oc_upload.php" method="post" enctype="multipart/form-data">
            <div class="container">
                <div class="form-block">
                    <h2 align="center">Missing Child Information</h2>
                    <div class="form-group">
                        <label for="oc_name">Name of the Child:</label>
                        <input type="text" id="oc_name" name="oc_name" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="oc_age">Age of the Child:</label>
                        <input type="number" id="oc_age" name="oc_age" min="0" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="found_place">Place of Found:</label>
                        <input type="text" id="found_place" name="found_place" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="found_date">Date of Found:</label>
                        <input type="date" id="found_date" name="found_date" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="oc_shirt_color">Shirt Color:</label>
                        <input type="text" id="oc_shirt_color" name="oc_shirt_color" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="oc_pant_color">Pant Color:</label>
                        <input type="text" id="oc_pant_color" name="oc_pant_color" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="oc_gender">Gender:</label>
                        <select id="oc_gender" name="oc_gender" required autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="oc_identifications">Identifications:</label>
                        <textarea id="oc_identifications" name="oc_identifications" rows="2" required autocomplete="off"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="oc_extra_info">Extra Information:</label>
                        <textarea id="oc_extra_info" name="oc_extra_info" rows="2" required autocomplete="off"></textarea>
                    </div>
                </div>
                <div class="form-block">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="o_name" name="o_name" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="o_phone">Your Number:</label>
                        <input type="tel" id="o_phone" name="o_phone" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="o_address">Your Address:</label>
                        <textarea id="o_address" name="o_address" rows="4" required autocomplete="off"></textarea>
                    </div>
